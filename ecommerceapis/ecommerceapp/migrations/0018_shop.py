...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ecommerceapp', '0017_user_addresses'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, primary_key=True, serialize=False, to='ecommerceapp.address')),
